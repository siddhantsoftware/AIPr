...
public class DiseaseConsultationChatBot 
{
    public static void main(String[] args) 
    {
        ...
        while (!message.equalsIgnoreCase("bye")) 
        {
            ...
            //System.out.println("3. I need to find a doctor or medical facility near me.");
    ...
    // check for common symptoms and provide a preliminary diagnosis
    ...
    /*public static String conditionManagement() {
        // implement condition management logic here
        return "I'm sorry, condition management advice is not implemented yet.";
    }*/
    ...
    // provide advice based on the condition
    switch (condition) {
        case "diabetes":
        ...
        case "asthma":
            return "To manage asthma, it's important to avoid triggers such as cigarette smoke or air pollution, take any prescribed medications as directed, and monitor your symptoms regularly. Make sure to follow your doctor's recommendations and attend regular check-ups.";
        case "hypertension":
            return "To manage hypertension, it's important to maintain a healthy diet, exercise regularly, avoid smoking and excessive alcohol consumption, and take any prescribed medications as directed. Make sure to follow your doctor's recommendations and attend regular check-ups.";
        default:
    ...
    public static String findMedicalFacility() {
        // implement medical facility finder logic here
        return "I'm sorry, medical facility finding is not implemented yet.";
    }
}
